...
export default function BottomSheet({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 z-[2000] bg-black/20 animate-fade-in"
        onClick={onClose}
      />
      ...
      <div
        ref={sheetRef}
        className="fixed bottom-0 left-0 right-0 z-[2001] rounded-t-3xl overflow-hidden animate-slide-up"
        style={{
